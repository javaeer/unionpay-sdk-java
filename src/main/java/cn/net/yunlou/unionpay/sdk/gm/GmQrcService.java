...
import cn.net.yunlou.unionpay.sdk.QrcService;
...
import static cn.net.yunlou.unionpay.sdk.SDKConstants.QRC_SIGNTYPE_SM3WITHSM2;
import static cn.net.yunlou.unionpay.sdk.SDKConstants.VERSION_1_0_0;
...
public class GmQrcService {
	 ...
	 * @param base64data Base64编码的加密数据<br>
	 * @param encoding 编码格式<br>
	 * @return 解析后的参数映射<br>
	 */
