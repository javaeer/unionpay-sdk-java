...
/**
 * AcpService
 *  acpsdk接口服务类，接入商户集成请可以直接参考使用本类中的方法
 * 2016-7-22 下午2:44:37
...
/**
	 ...
	 * @param encoding 编码格式<br>
	 * @return 加密的密文<br>
	 * @deprecated 5.1.0开发包已删除此方法，5.1.0接口请直接使用encryptData方法加密磁道信息
	 */
