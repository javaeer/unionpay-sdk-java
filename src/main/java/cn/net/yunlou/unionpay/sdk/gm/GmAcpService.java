...
import cn.net.yunlou.unionpay.sdk.AcpService;
import cn.net.yunlou.unionpay.sdk.SDKConstants;
import cn.net.yunlou.unionpay.sdk.SDKUtil;
import cn.net.yunlou.unionpay.sdk.SecureUtil;
...
import static cn.net.yunlou.unionpay.sdk.SDKUtil.createLinkString;
import static cn.net.yunlou.unionpay.sdk.SDKUtil.parseRespString;
...
public class GmAcpService {
	 ...
	 * 
	 * @param customerInfo 客户信息字符串<br>
	 * @param encoding 编码格式<br>
	 * @return 解析后的客户信息映射<br>
	 */
	 ...
	 * 
	 * @param customerInfo 客户信息字符串<br>
	 * @param certPath 证书路径<br>
	 * @param certPwd 证书密码<br>
	 * @param encoding 编码格式<br>
	 * @return 解析后的客户信息映射<br>
	 */
	 ...
	 * @return 构造后的cardTransData字符串<br>
	 */
	 ...
	 * 对字符串做base64<br>
	 * 
	 * @param rawStr 原始字符串<br>
	 * @param encoding 编码格式<br>
	 * @return Base64编码后的字符串<br>
	 */
	 ...
	 * 对字符串做base64<br>
	 * 
	 * @param base64Str Base64编码的字符串<br>
	 * @param encoding 编码格式<br>
	 * @return 解码后的原始字符串<br>
	 */
