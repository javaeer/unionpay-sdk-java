package cn.net.yunlou.unionpay.sdk;
...
/**
 * sdk接口服务类，接入商户集成请可以直接参考使用本类中的方法
...
public class QrcService {
	...
	/**
	 * 将Map转换为base64编码的加密格式<br>
	 * @param map 键值对Map<br>
	 * @param encoding 编码格式<br>
	 * @return Base64编码后的加密字符串<br>
	 */
	...
	/**
	 * 解析base64编码格式的返回报文payerInfo域，敏感信息不加密时使用<br>
	 * @param base64data Base64编码的数据<br>
	 * @param encoding 编码格式<br>
	 * @return 解析后的键值对Map<br>
	 */
	...
	/**
	 * 解析base64编码格式的返回报文payerInfo域，敏感信息加密时使用<br>
	 * @param base64data Base64编码的数据<br>
	 * @param encoding 编码格式<br>
	 * @return 解析后的键值对Map<br>
	 */
	...
	/**
	 * 解析base64编码格式的返回报文payerInfo域，敏感信息加密时使用，多证书方式<br>
	 * @param base64data Base64编码的数据<br>
