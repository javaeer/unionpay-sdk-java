...
import static cn.net.yunlou.unionpay.sdk.SDKConstants.POINT;
import static cn.net.yunlou.unionpay.sdk.SDKConstants.UNIONPAY_CNNAME;
...
public class GmCertUtil{
	...
	private static void initMiddleCert() {
        ...
        middleCert = PemUtils.loadX509FromPath(path);
